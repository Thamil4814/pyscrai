...
class QdrantService:
    ...
    async def add_entity_embedding(
        ...
        # Debug: print point structure before upsert
        logger.debug(f"Upserting entity embedding: id={uuid_id}, entity_id={entity_id}, payload_keys={list((point.payload or {}).keys())}, payload={point.payload}")
        ...
        try:
            ...
            logger.error(f"AssertionError during upsert: {e}. Point: id={uuid_id}, entity_id={entity_id}, payload={point.payload}")
            raise

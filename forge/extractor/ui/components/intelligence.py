...
Provides Logs compatible components for semantic profiles, narratives, and graph analytics.
"""
...
def render_semantic_profile(schema: Dict[str, Any]) -> ft.Control:
    ...
    for attr in attributes[:8]:  # Limit to 8 attributes
        attribute_chips.append(
            ft.Container(
                content=ft.Text(attr, size=12, color=ft.Colors.WHITE),
    ...
    for rel in key_relationships[:5]:  # Limit to 5 relationships
        relationship_items.append(
            ft.Row(
                [
                    ft.Icon(ft.Icons.ARROW_RIGHT, size=15, color=ft.Colors.CYAN_400),
                    ft.Text(rel, size=13, color=ft.Colors.WHITE70),
                ],
                spacing=4,
            )
        )
    ...
    return ft.Container(
        content=ft.Column(
            [
                ...
                ft.Row(
                    [
                        ft.Icon(ft.Icons.VERIFIED, size=15, color=ft.Colors.GREEN_400),
                        ft.Text(
    ...
    for line in narrative.split("\n"):
        ...
        # List items
            ...
            narrative_lines.append(
                ft.Row(
                    [
                        ft.Text("•", color=ft.Colors.CYAN_400, size=15),
                        ft.Text(line[2:], color=ft.Colors.WHITE70, size=14, expand=True),
                    ],
                    spacing=8,
                )
            )
        # Regular text
            ...
            narrative_lines.append(
                ft.Text(line, color=ft.Colors.WHITE70, size=14)
            )
                ...
                ft.Row(
                    [
                        ft.Container(
                            content=ft.Row(
                                [
                                    ft.Icon(ft.Icons.ACCOUNT_BOX, size=17, color=ft.Colors.CYAN_400),
                                    ft.Text(f"{entity_count} entities", size=13, color=ft.Colors.WHITE70),
                                ],
                                spacing=4,
                            ),
                        ...
                        ft.Container(
                            content=ft.Row(
                                [
                                    ft.Icon(ft.Icons.LINK, size=17, color=ft.Colors.ORANGE_400),
                                    ft.Text(f"{relationship_count} relationships", size=13, color=ft.Colors.WHITE70),
                                ],
                                spacing=4,
                            ),
    ...
    for item in most_connected:
        ...
        connected_items.append(
            ft.Row(
                [
                    ft.Container(
                        content=ft.Text(f"{degree:.2f}", size=12, color=ft.Colors.BLACK),
                        bgcolor=ft.Colors.CYAN_400,
                        padding=ft.padding.symmetric(horizontal=6, vertical=2),
                        border_radius=4,
                    ),
                    ft.Text(entity, size=13, color=ft.Colors.WHITE70, expand=True),
                ],
                spacing=8,
            )
        )
    ...
    for item in bridges:
        ...
        bridge_items.append(
            ft.Row(
                [
                    ft.Container(
                        content=ft.Text(f"{betweenness:.2f}", size=12, color=ft.Colors.BLACK),
                ...
                ft.Row(
                    [
                        ft.Container(
                            content=ft.Column(
                                [
                                    ft.Text("Nodes", size=12, color=ft.Colors.WHITE60),
                                    ft.Text(str(num_nodes), size=22, weight=ft.FontWeight.W_700, color=ft.Colors.CYAN_400),
                                ],
                                spacing=2,
                        ...
                        ft.Container(
                            content=ft.Column(
                                [
                                    ft.Text("Edges", size=12, color=ft.Colors.WHITE60),
                                    ft.Text(str(num_edges), size=22, weight=ft.FontWeight.W_700, color=ft.Colors.ORANGE_400),
                                ],
                                spacing=2,
                                horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                            ),
                        ...
                        ft.Container(
                            content=ft.Column(
                                [
                                    ft.Text("Density", size=12, color=ft.Colors.WHITE60),
                                    ft.Text(f"{density:.2%}", size=22, weight=ft.FontWeight.W_700, color=ft.Colors.GREEN_400),
                                ],
                                spacing=2,
                                horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                            ),
    ...
    return ft.Container(
        ...
        content=ft.Row(
            [
                ...
                ft.Column(
                    [
                        ft.Text(label, size=15, weight=ft.FontWeight.W_600, color=ft.Colors.WHITE),
                        ft.Row(
                            [
                                ft.Container(
                                    content=ft.Text(entity_type, size=11, color=ft.Colors.BLACK),
                                    bgcolor=type_color,
                                    padding=ft.padding.symmetric(horizontal=6, vertical=2),
                                    border_radius=4,
                                ),
